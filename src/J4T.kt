...
fun main() {
        ...
        if ((foundHardSecond && foundHardFirst) && (firstProductIndex=="P" && secondProductIndex=="P")) mainn(firstProductModified, secondProduct)
}
fun mainn(firstProduct: String, secondProduct: String) {
        val anion1 = arrayOf("", "")
        val anion2 = arrayOf("", "")
        val kation1 = arrayOf("", "")
        val kation2 = arrayOf("", "")
        ...
        val newFirstProductP = tablee.any { newFirstProduct.contains(it[0]) && it[1] == "P" }
        val newSecondProductP = tablee.any { newSecondProduct.contains(it[0]) && it[1] == "P" }
